...
export const metadata = buildMetadata({
  title: page?.metaTitle ?? "Get Matched With Insurance Help",
  description:
    page?.metaDescription ??
    "Get matched with insurance help in Maryland, Virginia, or Washington, D.C.",
  path: LEAD_PATH,
  ...
  return (
    <SectionSurface tone="blue">
      <Container size="wide" className="py-8 lg:py-12">
        <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Get Matched With Insurance Help" }]} />
        <div className="mt-8 grid items-start gap-10 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-4 max-w-md text-lg leading-relaxed text-slate-600">
              ...
              answers to match you with a licensed insurance professional when available.
            </p>
