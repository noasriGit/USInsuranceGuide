...
export function StickyMobileLeadCTA({ context }: StickyMobileLeadCTAProps) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-line bg-white/95 px-4 py-3 lg:hidden supports-[backdrop-filter]:bg-white/90 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
