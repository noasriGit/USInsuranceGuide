...
metaTitle: "Condo Insurance Explained for MD, VA, and D.C."
metaDescription: "Condo insurance (HO-6) covers walls-in property, belongings, liability, and loss assessment. Learn how it differs from homeowners and renters coverage."
excerpt: "Condo insurance (HO-6) is a unit-owner policy that sits beside the association master policy. This guide explains walls-in coverage, loss assessment, flood gaps, and how lender, association, and state rules differ in Maryland, Virginia, and Washington, D.C."
type: guide
...
faq:
  ...
  - question: "Should I buy replacement cost or actual cash value coverage?"
...
sources:
  - title: "Maryland Insurance Administration: Condominium Insurance"
    url: "https://insurance.maryland.gov/Consumer/Pages/condoinsurance.aspx"
    publisher: "Maryland Insurance Administration"
  - title: "Maryland Insurance Administration: Condo Insurance FAQs"
...
This guide is educational. Policy language, association bylaws, and lender conditions vary. A licensed insurance professional can review your master policy summary, condo documents, and unit upgrades before you set limits. For broader property context, see our [home insurance guides](/home-insurance/), [Maryland homeowners insurance](/states/maryland/homeowners-insurance/), [Virginia homeowners insurance](/states/virginia/homeowners-insurance/), and [Washington, D.C. homeowners insurance](/states/washington-dc/homeowners-insurance/).

## How HO-6, HO-3, and HO-4 Differ

The [Maryland Insurance Administration](https://insurance.maryland.gov/Consumer/Pages/condo/faqs.aspx) draws a clear line: a single-family home is usually covered by one homeowners policy, most often an HO-3. A condominium is usually covered by two policies: the association master policy and the unit owner's HO-6.
...
If you rent a condo, you generally need [Maryland renters insurance](/states/maryland/renters-insurance/), [Virginia renters insurance](/states/virginia/renters-insurance/), or [Washington, D.C. renters insurance](/states/washington-dc/renters-insurance/), not an HO-6. If you own the unit, an HO-4 leaves interior building items and loss assessment largely unaddressed.
...
Maryland law requires the association to obtain a master policy, and the premium is a common expense. The [MIA condo insurance page](https://insurance.maryland.gov/Consumer/Pages/condoinsurance.aspx) states that the master policy generally protects the basic structure of the unit, including walls, floors, and fixtures from original construction, such as original carpeting and kitchen cabinets. It also provides liability coverage for the association.
...
The MIA notes that loss assessment coverage may apply, subject to terms and limits, when a common-area claim exceeds the master policy or falls inside the master deductible. Ask how much is included. Many owners also discuss [umbrella insurance](/blog/umbrella-insurance-explained/) once HO-6 liability limits are in place.
...
[DISB homeowners and renters tips](https://disb.dc.gov/page/insurance-tips-homeowners-and-renters) treat flood as a separate decision from the everyday home or renters policy. [FEMA FloodSmart](https://www.floodsmart.gov/) explains National Flood Insurance Program building and contents coverage. An association flood policy on the building often does not replace your contents.

For the coverage split, see [home insurance versus flood insurance](/blog/home-insurance-vs-flood-insurance/) and our [flood insurance guides](/flood-insurance/). A lender in a mapped high-risk zone may require flood insurance even when the association already has a master flood policy. Sewer or drain backup is also commonly excluded unless you add an endorsement, a frequent issue in older stacks with shared plumbing.
...
**Washington, D.C.** has a high share of condos, conversions, and older housing. [DISB](https://disb.dc.gov/page/insurance) and its [homeowners and renters tips](https://disb.dc.gov/page/insurance-tips-homeowners-and-renters) emphasize that a building policy and an occupant policy do different jobs. In converted rowhouses and mid-century Northwest buildings, original finishes and later kitchen remodels often sit in the same stack. The master policy may restore builder-grade materials. The HO-6 is what funds the renovation you actually live with. High-rises in Navy Yard, Capitol Riverfront, NoMa, and along 14th Street concentrate water-damage exposure: one failed supply line can affect several units and then produce assessments.
...
- Do I need separate [flood insurance](/flood-insurance/) for my unit's contents or for a lender requirement?
