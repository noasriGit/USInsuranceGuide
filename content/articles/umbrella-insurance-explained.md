...
faq:
  - question: "What is umbrella insurance?"
    answer: "Umbrella insurance — also called personal umbrella liability insurance — is an excess liability policy that provides additional coverage above the limits of your underlying policies, such as auto, homeowners, renters, or boat insurance. It may also cover certain liability claims that underlying policies exclude."
  - question: "How does umbrella insurance work?"
    answer: "When a liability claim exceeds the limits of your underlying policy, umbrella insurance may pay the remaining amount — up to the umbrella policy limit — after the underlying policy pays its maximum. You must typically carry minimum underlying liability limits to qualify for an umbrella policy."
  - question: "What does umbrella insurance cover?"
    answer: "Umbrella insurance generally covers bodily injury and property damage liability above your underlying policies. It may also cover personal injury claims such as libel, slander, and false arrest that homeowners policies sometimes address. It does not cover your own property damage, business liability, or intentional acts."
  - question: "How much umbrella insurance can I buy?"
    answer: "Personal umbrella policies are commonly sold in increments of $1 million, with many carriers offering limits up to $5 million or more. The appropriate amount depends on your assets, income, risk exposure, and the limits of your underlying policies."
  - question: "Do I need umbrella insurance?"
    answer: "There is no universal requirement for umbrella insurance. It may be worth discussing if your assets exceed your underlying liability limits, you have significant risk exposures such as a pool or teenage drivers, or you want broader personal injury protection. A licensed professional can help you evaluate whether extra limits fit your situation."
  - question: "What underlying insurance do I need for an umbrella policy?"
...
sources:
  ...
  - title: "Umbrella Insurance Guides"
    url: "https://usinsuranceguide.com/umbrella-insurance/"
    publisher: "US Insurance Guide"
---
...
**Important distinction:** Personal umbrella insurance is different from commercial umbrella insurance, which provides excess liability above business policies such as [general liability](/blog/general-liability-insurance-explained/). This explainer focuses on personal umbrella coverage for individuals and families.
...
- **Business activities** — Business liability requires [commercial general liability](/blog/general-liability-insurance-explained/) and possibly a commercial umbrella
...
If you operate a business, personal umbrella coverage generally does not extend to business liability. Business owners may need [general liability](/blog/general-liability-insurance-explained/) and a separate commercial umbrella policy.
...
- **[Virginia](/states/virginia/)** — The Bureau of Insurance oversees personal lines products including umbrella policies
- **[Maryland](/states/maryland/)** — The Maryland Insurance Administration regulates umbrella coverage and consumer complaints
- **[Washington, D.C.](/states/washington-dc/)** — DISB regulates insurance products sold in the District
